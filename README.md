...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/liptech/proxmox-scripts/refs/heads/main/create.sh)"
```
...
```bash
bash -c "$(wget --no-cache -qO- https://raw.githubusercontent.com/liptech/proxmox-scripts/refs/heads/main/create.sh)" -s --app nginx-proxy-manager --cleanup
```
...
[Nginx Proxy Manager](https://github.com/liptech/proxmox-scripts/tree/main/apps/nginx-proxy-manager)
